...
while True:
	...
	cv2.moveWindow("Dilatation_without_opening", 2*imgx, imgy+100)
	cv2.imshow("Binarization_without_opening", Binarization_result_without_opening)
	cv2.moveWindow("Binarization_without_opening", 3*imgx, imgy+100)
	cv2.imshow("Contours identification_without_opening", frame2)
	cv2.moveWindow("Contours identification_without_opening", 4*imgx, imgy+100)
