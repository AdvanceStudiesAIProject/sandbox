...
background_supression_total_time = 0
...
menu.append('Time_spent_on_background_supression')
menu.append('Detection_time_spent_on_frame (seconds)')
menu.append('Total_time_spent_on_frame (seconds)')
menu.append('Accumulated_time_spent_on_background_supression')
...
while (1):
	...
	background_supression_time = time.time() - start_time
	background_supression_total_time = background_supression_total_time + background_supression_time
	...
	if len(squares) == 0:
		...
		cordinates.append(background_supression_time)
		cordinates.append(detection_time)
		cordinates.append(time_spent_on_frame)
		cordinates.append(background_supression_total_time)
	...
	detection_time = time.time() - background_supression_time - start_time
...
print("INFOS:")
print("Total time spend on background supression : ", background_supression_total_time)
