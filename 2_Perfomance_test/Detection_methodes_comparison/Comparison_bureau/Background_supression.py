...
while True:
	...
	Gaussian_result = cv2.GaussianBlur(bgs_result,(3,3),0)
	...
	Dilatation_result = cv2.dilate(Gaussian_result, dilatation_kernel, iterations=5)
	...
	# cv2.imshow("Erode", Erode_result)
	# cv2.moveWindow("Erode", imgx, 0)
	# cv2.imshow("Gaussian", Gaussian_result)
	# cv2.moveWindow("Gaussian", imgx, 0)
